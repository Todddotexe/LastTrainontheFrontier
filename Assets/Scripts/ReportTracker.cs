...
public class ReportTracker : MonoBehaviour
{
    ...
    public void ReportSummon()
    {
        if (DayTracker.currentDay == 1)
        {
            ...
            TextWriter.AddWriter_Static(reportPersonal, "On a personal note Captain, our departure was somewhat late for the season. A small but palpable tension can be felt amongst the passangers. I will let you know if morale is severly impacted, but for now it would be best to keep the temperment of your passengers in mind.", 0.03f, true);
        ...
        if (DayTracker.currentDay == 4)
        {
            ...
            if (IntercomTracker.Stowaway == false)
            {
                ...
                TextWriter.AddWriter_Static(reportPersonal, "Captain, it appears some discourse has errupted within the populace. The VIP's remarks have elevated to lecturing, and the passangers whispers have elevated into loud discussion. Combined, they have created an environment of arguements. Several times this morning I have been called to seperate the fueding parties. While I normally wouldn't inform you of the petty squabbles of your passangers, I thought it would be best for you to be notified early, and to expect an ultimatum in the coming days.", 0.03f, true);
            }
            DayTracker.bedButton.SetActive(true);
        }
        ...
        if (DayTracker.currentDay == 6)
        {
            if (IntercomTracker.Stowaway == true)
            {
                if (IntercomTracker.Outbreak == true)
                {
                    ...
                    TextWriter.AddWriter_Static(reportPersonal, "Captain, I fear the sickness may be out of hand, and Quarantine has come too late. Several passangers that had previously been cleared has now comeback positive, with several being found lurking in the supply car during the morning count. I blame myself for not treating this issue with more urgency. Medical staff have maintained that the sickness will pass, so I will do my duty and attempt to curb its spread.", 0.03f, true);
                }
                if (IntercomTracker.Outbreak == false)
                {
                    ...
                    TextWriter.AddWriter_Static(reportPersonal, "It is done. Overall, 13 souls were ejected from the train last night, including the Stowaway and several medical personnel. Though it was a hard choice, it is my duty to inform you that our employeers expected losses on this journey, and so any anxiety you may feel about the security of your job is unfounded. I know its not a comforting thing to hear, but you must persevere for the sake of your remaing passangers.", 0.03f, true);
                }
            }
            if (IntercomTracker.Stowaway == false)
            {
